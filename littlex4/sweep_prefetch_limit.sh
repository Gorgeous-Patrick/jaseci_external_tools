...
PREFETCH_LIMITS=(0 1000 2000 3000 4000 5000 6000 7000 8000 9000 10000)
LIST_SIZE=${JAC_TWEET_NUM:-10}
TRIALS=10
...
for limit in "${PREFETCH_LIMITS[@]}"; do
  ...
  JAC_TWEET_NUM=$LIST_SIZE JAC_PROFILE_DIR="$_prof_dir" JAC_PROFILE_CSV="$_profile_csv" \
