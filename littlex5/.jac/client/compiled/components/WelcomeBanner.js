/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/WelcomeBanner.cl.jac */
...
function WelcomeBanner(props) {
  ...
  return __jacJsx("div", {"className": "lx-welcome-banner"}, [__jacJsx("div", {"className": "lx-welcome-content"}, [__jacJsx("div", {"className": "lx-welcome-title"}, ["Welcome to LITTLE-X"]), __jacJsx("div", {"className": "lx-welcome-tips"}, [__jacJsx("span", {"className": "lx-welcome-tip"}, ["Post a thought to get started"]), __jacJsx("span", {"className": "lx-welcome-tip"}, ["Use #hashtags to join trending topics"]), __jacJsx("span", {"className": "lx-welcome-tip"}, ["Explore and follow people in Explore"])])]), __jacJsx("button", {"className": "lx-welcome-dismiss", "onClick": () => {
    onDismiss();
  }}, ["Got it"])]);
}
export {WelcomeBanner};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:WelcomeBanner": {"is_writer": false, "touches": ["*"]}}); };
