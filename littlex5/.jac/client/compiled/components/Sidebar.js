/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/Sidebar.cl.jac */
import {__jacJsx, __jacSpawn} from "@jac/runtime";
import { Home, Compass, Hash, User, Feather, LogOut } from "lucide-react";
const _jac = {
  int: {
    bit_length(n) {
      if (n === 0) return 0;
...
function Sidebar(props) {
  const {activeTab, displayUsername, profileUsername, profileAvatar, notifCount, onNavigate, onLogout} = props;
  return __jacJsx("aside", {"className": "lx-sidebar-left"}, [__jacJsx("div", {"className": "lx-brand"}, [__jacJsx("img", {"src": "/static/assets/littlex-logo.svg", "className": "lx-brand-logo", "alt": "little-x"}, []), __jacJsx("span", {"className": "lx-brand-name"}, ["LITTLE-X"])]), __jacJsx("nav", {"className": "lx-nav"}, [__jacJsx("div", {"className": ("lx-nav-item" + ((activeTab === "feed") ? " lx-nav-item-active" : "")), "onClick": () => {
    onNavigate("feed");
  }}, [__jacJsx(Home, {"size": 22}, []), __jacJsx("span", {}, ["Home"])]), __jacJsx("div", {"className": ("lx-nav-item" + ((activeTab === "explore") ? " lx-nav-item-active" : "")), "onClick": () => {
    onNavigate("explore");
  }}, [__jacJsx(Compass, {"size": 22}, []), __jacJsx("span", {}, ["Explore"])]), __jacJsx("div", {"className": ("lx-nav-item" + ((activeTab === "channels") ? " lx-nav-item-active" : "")), "onClick": () => {
    onNavigate("channels");
  }}, [__jacJsx(Hash, {"size": 22}, []), __jacJsx("span", {}, ["Channels"])]), __jacJsx("div", {"className": ("lx-nav-item" + ((activeTab === "profile") ? " lx-nav-item-active" : "")), "onClick": () => {
    onNavigate("profile");
  }}, [__jacJsx(User, {"size": 22}, []), __jacJsx("span", {}, ["Profile"]), (() => {
    let __jac_view_kids = [];
    if ((notifCount > 0)) {
      __jac_view_kids.push(__jacJsx("span", {"className": "lx-nav-badge"}, [String(notifCount)]));
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })()])]), __jacJsx("button", {"className": "lx-compose-btn", "onClick": () => {
    onNavigate("feed");
  }}, [__jacJsx(Feather, {"size": 18}, []), __jacJsx("span", {}, ["Post"])]), __jacJsx("div", {"style": {"flex": "1"}}, []), __jacJsx("div", {"className": "lx-sidebar-user"}, [__jacJsx("img", {"className": "lx-avatar", "src": profileAvatar, "alt": profileUsername}, []), __jacJsx("div", {"className": "lx-sidebar-user-info"}, [__jacJsx("div", {"className": "lx-sidebar-user-name"}, [displayUsername]), __jacJsx("div", {"className": "lx-sidebar-user-handle"}, [("@" + displayUsername)])]), __jacJsx("button", {"className": "lx-logout-icon-btn", "onClick": () => {
    onLogout();
  }}, [__jacJsx(LogOut, {"size": 18}, [])])])]);
}
export {Sidebar};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:Sidebar": {"is_writer": false, "touches": ["*"]}}); };
