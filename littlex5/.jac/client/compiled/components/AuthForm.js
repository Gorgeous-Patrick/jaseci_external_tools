/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/AuthForm.cl.jac */
...
function AuthForm(props) {
  const {isSignup, username, password, error, loading, onUsernameChange, onPasswordChange, onSubmit, onToggleMode} = props;
  return __jacJsx("div", {"className": "lx-auth-root"}, [__jacJsx("div", {"className": "lx-auth-left"}, [__jacJsx("img", {"src": "/static/assets/littlex-logo.svg", "className": "lx-auth-logo-big", "alt": "little-x"}, [])]), __jacJsx("div", {"className": "lx-auth-right"}, [__jacJsx("div", {"className": "lx-auth-box"}, [__jacJsx("img", {"src": "/static/assets/littlex-logo.svg", "className": "lx-auth-mobile-logo", "alt": "little-x"}, []), __jacJsx("div", {"className": "lx-auth-heading"}, ["LITTLE-X"]), __jacJsx("div", {"className": "lx-auth-sub"}, [(isSignup ? "Create your account and join the conversation" : "Sign in to your account")]), (() => {
    let __jac_view_kids = [];
    if (error) {
      __jac_view_kids.push(__jacJsx("div", {"className": "lx-auth-error"}, [error]));
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })(), __jacJsx("form", {"onSubmit": onSubmit, "className": "lx-auth-form-fields"}, [__jacJsx("input", {"className": "lx-input", "type": "text", "placeholder": "Username", "value": username, "onChange": onUsernameChange, "autoComplete": "username"}, []), __jacJsx("input", {"className": "lx-input", "type": "password", "placeholder": "Password", "value": password, "onChange": onPasswordChange, "autoComplete": (isSignup ? "new-password" : "current-password")}, []), __jacJsx("button", {"className": "lx-auth-btn", "type": "submit", "disabled": loading}, [(loading ? "Processing..." : (isSignup ? "Sign Up" : "Log In"))])]), __jacJsx("div", {"className": "lx-auth-toggle"}, [(isSignup ? "Already have an account? " : "New to Little-X? "), __jacJsx("span", {"className": "lx-auth-toggle-link", "onClick": onToggleMode}, [(isSignup ? "Log In" : "Sign Up")])])])])]);
}
export {AuthForm};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:AuthForm": {"is_writer": false, "touches": ["*"]}}); };
