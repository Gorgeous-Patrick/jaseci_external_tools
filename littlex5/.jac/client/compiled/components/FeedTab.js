/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/FeedTab.cl.jac */
...
function FeedTab(props) {
  const {showWelcome, onDismissWelcome, profileAvatar, profileUsername, composerText, onComposerChange, onPost, feedLoading, tweets, onLike, onComment, onDelete, onRepost} = props;
  return __jacJsx("div", {}, [(() => {
    let __jac_view_kids = [];
    if (showWelcome) {
      __jac_view_kids.push(__jacJsx(WelcomeBanner, {"onDismiss": onDismissWelcome}, []));
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })(), __jacJsx(Composer, {"avatar": profileAvatar, "avatarAlt": profileUsername, "placeholder": "What's happening?", "value": composerText, "onChange": onComposerChange, "onPost": onPost, "rows": 3, "buttonLabel": "Post", "showCharRing": true}, []), (() => {
    let __jac_view_kids_1 = [];
    if (feedLoading) {
      __jac_view_kids_1.push(__jacJsx("div", {"className": "lx-loading"}, ["Loading feed..."]));
      return __jacJsx(null, {}, [__jac_view_kids_1]);
    }
    if ((tweets.length === 0)) {
      __jac_view_kids_1.push(__jacJsx("div", {"className": "lx-empty"}, [__jacJsx("div", {"className": "lx-empty-title"}, ["Nothing here yet"]), __jacJsx("span", {}, ["Follow people or post something!"])]));
      return __jacJsx(null, {}, [__jac_view_kids_1]);
    }
...
export {FeedTab};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:FeedTab": {"is_writer": false, "touches": ["*"]}}); };
//# sourceMappingURL=FeedTab.js.map
