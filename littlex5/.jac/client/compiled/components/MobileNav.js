/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/MobileNav.cl.jac */
import {__jacJsx, __jacSpawn} from "@jac/runtime";
import { Home, Compass, Hash, User } from "lucide-react";
const _jac = {
  int: {
    bit_length(n) {
      if (n === 0) return 0;
...
function MobileNav(props) {
  const {activeTab, notifCount, onNavigate} = props;
  return __jacJsx("nav", {"className": "lx-mobile-nav"}, [__jacJsx("div", {"className": ("lx-mobile-nav-item" + ((activeTab === "feed") ? " lx-mobile-nav-item-active" : "")), "onClick": () => {
    onNavigate("feed");
  }}, [__jacJsx(Home, {"size": 24}, [])]), __jacJsx("div", {"className": ("lx-mobile-nav-item" + ((activeTab === "explore") ? " lx-mobile-nav-item-active" : "")), "onClick": () => {
    onNavigate("explore");
  }}, [__jacJsx(Compass, {"size": 24}, [])]), __jacJsx("div", {"className": ("lx-mobile-nav-item" + ((activeTab === "channels") ? " lx-mobile-nav-item-active" : "")), "onClick": () => {
    onNavigate("channels");
  }}, [__jacJsx(Hash, {"size": 24}, [])]), __jacJsx("div", {"className": ("lx-mobile-nav-item" + ((activeTab === "profile") ? " lx-mobile-nav-item-active" : "")), "onClick": () => {
    onNavigate("profile");
  }}, [__jacJsx(User, {"size": 24}, []), (() => {
    let __jac_view_kids = [];
    if ((notifCount > 0)) {
...
export {MobileNav};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:MobileNav": {"is_writer": false, "touches": ["*"]}}); };
