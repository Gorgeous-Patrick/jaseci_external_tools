/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/RightSidebar.cl.jac */
...
function RightSidebar(props) {
  const {searchQuery, onSearchChange, onSearch, onClearSearch, trendingTags, onTrendClick, toFollow, onFollow, onShowMore} = props;
  return __jacJsx("aside", {"className": "lx-sidebar-right"}, [__jacJsx("div", {"className": "lx-sidebar-right-inner"}, [__jacJsx("div", {"className": "lx-search-wrap"}, [__jacJsx("span", {"className": "lx-search-icon"}, [__jacJsx(Search, {"size": 16}, [])]), __jacJsx("input", {"className": "lx-search-input", "placeholder": "Search Little-X", "value": searchQuery, "onChange": e => {
    ...
    let __jac_view_kids = [];
    if (searchQuery) {
      __jac_view_kids.push(__jacJsx("button", {"className": "lx-search-clear", "title": "Clear search", "onClick": () => {
        onClearSearch();
      }}, [__jacJsx(X, {"size": 16}, [])]));
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })(), __jacJsx("button", {"className": "lx-search-btn", "onClick": () => {
    onSearch(searchQuery);
  }}, ["Search"])]), (() => {
    let __jac_view_kids_1 = [];
    if ((trendingTags.length > 0)) {
      __jac_view_kids_1.push(__jacJsx("div", {"className": "lx-widget"}, [__jacJsx("div", {"className": "lx-widget-title"}, ["Trending"]), (() => {
        let __jac_view_kids_2 = [];
        for (const t of trendingTags) {
          __jac_view_kids_2.push(__jacJsx("div", {"className": "lx-trend-item", "key": t.tag, "onClick": () => {
            onTrendClick(t.tag);
          }}, [__jacJsx("span", {"className": "lx-trend-tag"}, [t.tag]), __jacJsx("span", {"className": "lx-trend-count"}, [(String(t.count) + ((t.count === 1) ? " post" : " posts"))])]));
        }
    ...
    if ((toFollow.length > 0)) {
      __jac_view_kids_3.push(__jacJsx("div", {"className": "lx-widget"}, [__jacJsx("div", {"className": "lx-widget-title"}, ["Who to follow"]), (() => {
        let __jac_view_kids_4 = [];
        for (const u of toFollow.slice(0, 5)) {
          __jac_view_kids_4.push(__jacJsx("div", {"className": "lx-follow-item", "key": u.id}, [__jacJsx("img", {"className": "lx-avatar-sm", "src": ("https://i.pravatar.cc/150?u=fake@" + u.username), "alt": u.username}, []), __jacJsx("div", {"className": "lx-follow-item-info"}, [__jacJsx("div", {"className": "lx-follow-item-name"}, [(u.username.includes("@") ? u.username.split("@")[0] : u.username)]), __jacJsx("div", {"className": "lx-follow-item-handle"}, [("@" + (u.username.includes("@") ? u.username.split("@")[0] : u.username))])]), __jacJsx("button", {"className": "lx-follow-btn", "onClick": () => {
            onFollow(u.id);
          }}, ["Follow"])]));
        }
        return __jacJsx(null, {}, [__jac_view_kids_4]);
      })(), (() => {
        let __jac_view_kids_5 = [];
        if ((toFollow.length > 5)) {
          __jac_view_kids_5.push(__jacJsx("div", {"className": "lx-widget-show-more", "onClick": () => {
            onShowMore();
          }}, ["Show more"]));
        }
        return __jacJsx(null, {}, [__jac_view_kids_5]);
      })()]));
    }
    return __jacJsx(null, {}, [__jac_view_kids_3]);
  })(), __jacJsx("div", {"className": "lx-about-widget"}, [__jacJsx("div", {"className": "lx-about-title"}, ["LITTLE-X"]), __jacJsx("div", {"className": "lx-about-desc"}, ["A decentralized social platform built with Jac. Share thoughts, follow people, join conversations."]), __jacJsx("div", {"className": "lx-about-links"}, [__jacJsx("span", {"className": "lx-about-tag"}, ["#jacdev"]), __jacJsx("span", {"className": "lx-about-tag"}, ["#jaseci"]), __jacJsx("span", {"className": "lx-about-tag"}, ["#open-source"])])])])]);
}
export {RightSidebar};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:RightSidebar": {"is_writer": false, "touches": ["*"]}}); };
