/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/ChannelsTab.cl.jac */
...
function ChannelsTab(props) {
  const {channels, channelsLoading, selectedChannel, channelPosts, profileAvatar, profileUsername, onCreateChannel, onJoinChannel, onLeaveChannel, onSelectChannel, onChannelPost, onBackToChannels, onLike, onComment, onDelete, onRepost} = props;
  const [showCreateChannel, setShowCreateChannel] = useState(false);
  const [newChannelName, setNewChannelName] = useState("");
  const [newChannelDescription, setNewChannelDescription] = useState("");
  const [channelComposerText, setChannelComposerText] = useState("");
  return __jacJsx("div", {}, [(() => {
    let __jac_view_kids = [];
    if ((selectedChannel === null)) {
      __jac_view_kids.push(__jacJsx("div", {"className": "lx-channel-actions"}, [__jacJsx("button", {"className": "lx-post-btn", "onClick": () => {
        setShowCreateChannel(!showCreateChannel);
      }}, [__jacJsx(Plus, {"size": 16}, []), "Create Channel"])]));
      if (showCreateChannel) {
        __jac_view_kids.push(__jacJsx("div", {"className": "lx-channel-create-form"}, [__jacJsx("input", {"className": "lx-input", "placeholder": "Channel name", "value": newChannelName, "onChange": e => {
          setNewChannelName(e.target.value);
        }}, []), __jacJsx("input", {"className": "lx-input", "placeholder": "Description (optional)", "value": newChannelDescription, "onChange": e => {
          setNewChannelDescription(e.target.value);
        }}, []), __jacJsx("div", {"style": {"display": "flex", "gap": "0.5rem"}}, [__jacJsx("button", {"className": "lx-post-btn", "disabled": !newChannelName.trim(), "onClick": () => {
          onCreateChannel(newChannelName.trim(), newChannelDescription.trim());
          setNewChannelName("");
          setNewChannelDescription("");
          setShowCreateChannel(false);
        }}, ["Create"]), __jacJsx("button", {"className": "lx-edit-profile-btn", "onClick": () => {
          setShowCreateChannel(false);
          setNewChannelName("");
          setNewChannelDescription("");
        }}, ["Cancel"])])]));
      ...
      if (channelsLoading) {
        __jac_view_kids.push(__jacJsx("div", {"className": "lx-loading"}, ["Loading channels..."]));
        return __jacJsx(null, {}, [__jac_view_kids]);
      }
      if ((channels.length === 0)) {
        __jac_view_kids.push(__jacJsx("div", {"className": "lx-empty"}, [__jacJsx("div", {"className": "lx-empty-title"}, ["No channels yet"]), __jacJsx("span", {}, ["Create one to get started!"])]));
        return __jacJsx(null, {}, [__jac_view_kids]);
      }
      for (const ch of channels) {
        __jac_view_kids.push(__jacJsx("div", {"className": "lx-channel-item", "key": ch.id, "onClick": () => {
          onSelectChannel(ch.id);
        }}, [__jacJsx("div", {"className": "lx-channel-icon"}, [__jacJsx(Hash, {"size": 20}, [])]), __jacJsx("div", {"className": "lx-channel-item-info"}, [__jacJsx("div", {"className": "lx-channel-item-name"}, [ch.name]), (() => {
          let __jac_view_kids_1 = [];
          if (ch.description) {
            __jac_view_kids_1.push(__jacJsx("div", {"className": "lx-channel-item-desc"}, [ch.description]));
          }
          return __jacJsx(null, {}, [__jac_view_kids_1]);
        })(), __jacJsx("div", {"className": "lx-channel-item-meta"}, [__jacJsx(Users, {"size": 12}, []), __jacJsx("span", {}, [(String(ch.member_count) + ((ch.member_count === 1) ? " member" : " members"))])])]), (() => {
          let __jac_view_kids_2 = [];
          if (ch.is_member) {
            __jac_view_kids_2.push(__jacJsx("span", {"className": "lx-channel-joined-badge"}, ["Joined"]));
          }
          return __jacJsx(null, {}, [__jac_view_kids_2]);
        })()]));
      }
    } else {
      __jac_view_kids.push(__jacJsx("div", {"className": "lx-channel-header"}, [__jacJsx("button", {"className": "lx-edit-profile-btn", "onClick": () => {
        onBackToChannels();
      }, "style": {"display": "flex", "alignItems": "center", "gap": "0.3rem"}}, [__jacJsx(ArrowLeft, {"size": 16}, []), "Back"]), __jacJsx("div", {"className": "lx-channel-name"}, [__jacJsx(Hash, {"size": 20}, []), selectedChannel.name]), (() => {
        let __jac_view_kids_3 = [];
        if (selectedChannel.description) {
          __jac_view_kids_3.push(__jacJsx("div", {"className": "lx-channel-desc"}, [selectedChannel.description]));
        }
        return __jacJsx(null, {}, [__jac_view_kids_3]);
      })(), __jacJsx("div", {"className": "lx-channel-meta"}, [__jacJsx(Users, {"size": 14}, []), __jacJsx("span", {}, [(String(selectedChannel.member_count) + ((selectedChannel.member_count === 1) ? " member" : " members"))]), (() => {
        let __jac_view_kids_4 = [];
        if (selectedChannel.is_member) {
          __jac_view_kids_4.push(__jacJsx("button", {"className": "lx-edit-profile-btn", "onClick": () => {
            if (selectedChannel) {
              onLeaveChannel(selectedChannel.id);
            }
          }}, ["Leave"]));
        } else {
          __jac_view_kids_4.push(__jacJsx("button", {"className": "lx-follow-btn", "onClick": () => {
            if (selectedChannel) {
              onJoinChannel(selectedChannel.id);
            }
          }}, ["Join"]));
        }
        return __jacJsx(null, {}, [__jac_view_kids_4]);
      })()])]));
      if (selectedChannel.is_member) {
        __jac_view_kids.push(__jacJsx(Composer, {"avatar": profileAvatar, "avatarAlt": profileUsername, "placeholder": ("Post in #" + selectedChannel.name), "value": channelComposerText, "onChange": v => {
          setChannelComposerText(v);
        }, "onPost": () => {
          onChannelPost(channelComposerText);
          setChannelComposerText("");
        }, "rows": 2, "buttonLabel": "Post", "showCharRing": false}, []));
      }
      if ((channelPosts.length === 0)) {
        __jac_view_kids.push(__jacJsx("div", {"className": "lx-empty"}, [__jacJsx("div", {"className": "lx-empty-title"}, ["No posts yet"]), __jacJsx("span", {}, [(selectedChannel.is_member ? "Be the first to post!" : "Join this channel to post!")])]));
        return __jacJsx(null, {}, [__jac_view_kids]);
      }
      for (const tweet of channelPosts) {
        __jac_view_kids.push(__jacJsx(TweetCard, {"key": tweet.id, "tweet": tweet, "myUsername": profileUsername, "onLike": onLike, "onComment": onComment, "onDelete": onDelete, "onRepost": onRepost}, []));
      }
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })()]);
...
export {ChannelsTab};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:ChannelsTab": {"is_writer": false, "touches": ["*"]}}); };
//# sourceMappingURL=ChannelsTab.js.map
