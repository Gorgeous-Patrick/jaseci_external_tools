/* Source: /home/patrickli/Space/jaseci_env/jaseci/jac/examples/littleX/components/TweetCard.cl.jac */
...
function TweetCard(props) {
  const {tweet, myUsername, onLike, onComment, onDelete, onRepost} = props;
  const [showComments, setShowComments] = useState(false);
  const [commentText, setCommentText] = useState("");
  let is_liked = tweet.likes.includes(myUsername);
  let like_count = String(tweet.likes.length);
  let comment_count = String(tweet.comments.length);
  let author_avatar = ("https://i.pravatar.cc/150?u=fake@" + tweet.author_username);
  let raw_name = (tweet.author_username || "unknown");
  let display_name = (raw_name.includes("@") ? raw_name.split("@")[0] : raw_name);
  let diff_ms = (tweet.created_at ? (Date.now() - Reflect.construct(Date, [tweet.created_at]).getTime()) : 0);
  let diff_min = Math.trunc(Number((diff_ms / 60000)));
  let diff_hr = Math.trunc(Number((diff_min / 60)));
  let diff_day = Math.trunc(Number((diff_hr / 24)));
  let date_str = (tweet.created_at ? ((diff_min < 1) ? "now" : ((diff_hr < 1) ? (String(diff_min) + "m") : ((diff_day < 1) ? (String(diff_hr) + "h") : ((diff_day < 30) ? (String(diff_day) + "d") : tweet.created_at.slice(0, 10))))) : "");
  return __jacJsx("div", {"className": "lx-tweet"}, [__jacJsx("img", {"className": "lx-avatar", "src": author_avatar, "alt": tweet.author_username}, []), __jacJsx("div", {"className": "lx-tweet-body"}, [__jacJsx("div", {"className": "lx-tweet-header"}, [__jacJsx("span", {"className": "lx-tweet-name"}, [display_name]), __jacJsx("span", {"className": "lx-tweet-handle"}, [("@" + display_name)]), __jacJsx("span", {"className": "lx-tweet-dot"}, ["·"]), __jacJsx("span", {"className": "lx-tweet-time"}, [date_str])]), __jacJsx("div", {"className": "lx-tweet-text"}, [tweet.content]), __jacJsx("div", {"className": "lx-tweet-actions"}, [__jacJsx("button", {"className": "lx-act-btn lx-act-comment", "onClick": () => {
    setShowComments(!showComments);
  }}, [__jacJsx(MessageCircle, {"size": 16}, []), __jacJsx("span", {}, [comment_count])]), __jacJsx("button", {"className": "lx-act-btn lx-act-repost", "onClick": () => {
    onRepost(tweet.id, tweet.content, tweet.author_username);
  }, "title": "Repost"}, [__jacJsx(Repeat2, {"size": 16}, [])]), __jacJsx("button", {"className": (is_liked ? "lx-act-btn lx-act-liked" : "lx-act-btn lx-act-like"), "onClick": () => {
    onLike(tweet.id);
  }}, [__jacJsx(Heart, {"size": 16}, []), __jacJsx("span", {}, [like_count])]), (() => {
    let __jac_view_kids = [];
    if (tweet.is_mine) {
      __jac_view_kids.push(__jacJsx("button", {"className": "lx-act-btn lx-act-delete", "onClick": () => {
        if (confirm("Delete this post? This cannot be undone.")) {
          onDelete(tweet.id);
        }
      }}, [__jacJsx(Trash2, {"size": 16}, [])]));
    }
    return __jacJsx(null, {}, [__jac_view_kids]);
  })()]), (() => {
    let __jac_view_kids_1 = [];
    if (showComments) {
      __jac_view_kids_1.push(__jacJsx("div", {"className": "lx-comments-section"}, [(() => {
        let __jac_view_kids_2 = [];
        for (const c of tweet.comments) {
          __jac_view_kids_2.push(__jacJsx("div", {"className": "lx-comment-item", "key": c["created_at"]}, [__jacJsx("img", {"className": "lx-avatar-sm", "src": ("https://i.pravatar.cc/150?u=fake@" + c["username"]), "alt": c["username"]}, []), __jacJsx("div", {}, [__jacJsx("div", {"className": "lx-comment-meta"}, [__jacJsx("strong", {}, [c["username"]])]), __jacJsx("div", {"className": "lx-comment-text"}, [c["content"]])])]));
        }
        return __jacJsx(null, {}, [__jac_view_kids_2]);
      })(), __jacJsx("div", {"className": "lx-comment-form"}, [__jacJsx("input", {"className": "lx-comment-input", "placeholder": "Reply...", "value": commentText, "onChange": e => {
      ...
      }}, []), __jacJsx("button", {"className": "lx-comment-submit", "onClick": () => {
        if (commentText.trim()) {
          onComment(tweet.id, commentText);
          setCommentText("");
        }
...
export {TweetCard};
if (typeof globalThis !== "undefined") { if (!globalThis.__jacEndpointEffects__) globalThis.__jacEndpointEffects__ = {}; Object.assign(globalThis.__jacEndpointEffects__, {"func:TweetCard": {"is_writer": false, "touches": ["*"]}}); };
//# sourceMappingURL=TweetCard.js.map
