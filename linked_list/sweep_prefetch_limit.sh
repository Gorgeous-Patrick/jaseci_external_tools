...
PREFETCH_LIMITS=(0 50 100 200 500 1000 1500 2000 3000)
...
for limit in "${PREFETCH_LIMITS[@]}"; do
  ...
  JAC_LIST_SIZE=$LIST_SIZE JAC_PROFILE_DIR="$_prof_dir" JAC_PROFILE_CSV="$_profile_csv" bash quick_run.sh 2>&1 | tee "$QUICK_RUN_OUTPUT"
